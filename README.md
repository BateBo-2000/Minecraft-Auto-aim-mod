...
* **Performance Focused:** Built using the Fabric specialized `ClientTickEvents` to ensure zero FPS drop.
...
| :--- | :--- | :--- |
| **Hold to Aim** | `K` | Snaps your camera to the closest player while held. |
| **Toggle Auto-Aim** | `NONE` | (Bind in Settings) Turns the auto-aim on permanently. |

> **Note:** To change these, go to **Options -> Controls -> Key Binds** and look for the **Bokkata's Mod** category.
